...
async function loadMobileNetFeatureModel() {
  const URL = 'https://tfhub.dev/google/tfjs-model/imagenet/mobilenet_v3_large_075_224/feature_vector/5/default/1';
...
model.add(tf.layers.dense({inputShape: [1280], units: 512, activation: 'relu'}));
model.add(tf.layers.dense({inputShape: [512], units: 256, activation: 'relu'}));
model.add(tf.layers.dense({inputShape: [256], units: 128, activation: 'relu'}));
